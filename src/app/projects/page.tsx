...
// // ✅ ZMIENIONE: było "export const PortfolioSection", teraz "export default function ProjectsPage"
...
//       ref={ref}
//       id="projects"
//       className="pt-40 md:pt-40 relative overflow-hidden"
//       style={{
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://whiteslope.studio/projects-og-image.jpg', // Podmień na swoje zdjęcie
        width: 1200,
        height: 630,
...
export default function ProjectsPage() {
  return (
    // bg-zinc-950 i text-zinc-50 nadają kinowy, ciemny, prestiżowy klimat
    <div className="min-h-screen bg-zinc-950 text-zinc-50 pb-[80px]">
      ...
      {/* 4. SEKCJA KONTAKTOWA (Call to Action) */}
