...
export const metadata: Metadata = {
  title: 'Aktualności - WHITESLOPE STUDIO | Web Development, AI i E-marketing',
  description: 'Odkryj najnowsze trendy w świecie web developmentu, automatyzacji AI oraz e-marketingu. Praktyczna wiedza i case studies od Whiteslope Studio.',
  keywords: 'aktualności technologiczne, web development, sztuczna inteligencja w biznesie, automatyzacja, marketing internetowy, SEO, tworzenie stron, SaaS',
  openGraph: {
    title: 'Aktualności - WHITESLOPE STUDIO',
    description: 'Najnowsze trendy: web development, automatyzacja AI i marketing.',
    url: 'https://whiteslope.studio/blog',
    type: 'website',
    images: [
      {
...
export default function BlogPage() {
  return (
    // PRZYWRÓCONE pt-[120px] - bez tego pierwsza sekcja chowa się pod menu!
    <div className="min-h-screen bg-zinc-50 pb-[80px]">
      ...
      {/* 5. Długi tekst SEO pod pozycjonowanie na dole strony */}
      <BlogSeoSection />
