      ...
      <div className="max-w-[1640px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-row justify-center gap-12 lg:gap-16 pb-16">
          ...
          <div className="pt-4 shrink-0 w-[260px]">
            ...
            {/* Mapa Google z zaznaczonym Białymstokiem - ładowana dopiero po kliknięciu (Google Maps JS SDK to ~220 KiB) */}
            <div className="rounded-[16px] overflow-hidden border border-white/10 h-[140px] relative bg-white/5">
              {mapLoaded ? (
                <iframe
