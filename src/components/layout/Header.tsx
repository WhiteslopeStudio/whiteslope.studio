...
// import { HOMEPAGE_MENU_ITEMS, SUBPAGES_MENU_ITEMS, APP_CONFIG } from '@/lib/constants';
...
//   const sections = HOMEPAGE_MENU_ITEMS.filter(item => item.type === 'section' && item.href !== '#home');
...
//           isScrolled 
//             ? 'bg-black/95 backdrop-blur-lg border-b border-[#DD9C90]/30 shadow-lg' 
...
//             {/* Logo */}
//             <motion.div
//               className="cursor-pointer transition-transform duration-300 hover:scale-103"
...
//                         {activeSection === 'home' 
//                           ? 'Home' 
//                           : sections.find(item => item.href.substring(1) === activeSection)?.label || 'Sekcje'
//                         }
//                       </span>
//                       <motion.div
...
//                           transition={{ duration: 0.2 }}
//                           className="absolute top-full left-0 mt-2 w-56 bg-gray-900/95 backdrop-blur-lg border border-gray-700 rounded-xl shadow-2xl overflow-hidden"
//                         >
//                           <div className="py-2">
...
//                     initial={{ opacity: 0, y: -20 }}
//                     animate={{ opacity: 1, y: 0 }}
//                     transition={{ duration: 0.5, delay: (isHomepage ? 0.2 : 0) + index * 0.1 }}
//                     whileHover={{ scale: 1.05 }}
//                   >
//                     {item.label}
//                   </motion.button>
...
//                   className="flex items-center space-x-3 mb-8 pb-6 border-b border-gray-700"
//                 >
...
//                         transition={{ duration: 0.3 }}
//                         className="text-gray-500 text-xs uppercase tracking-wide px-4 py-2 border-b border-gray-800"
//                       >
//                         Sekcje strony
//                       </motion.div>
...
//                   className="border-t border-gray-700 pt-6 space-y-3"
//                 >
...
//                       className="text-[#DD9C90] hover:text-[#DD9C90]/80 transition-colors text-sm"
//                     >
//                       {APP_CONFIG.email}
//                     </a>
//                   </div>
