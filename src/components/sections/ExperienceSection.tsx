...
import { FaChartLine, FaFire } from "react-icons/fa6";
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-3xl lg:text-6xl md:font-thin text-white mb-8 tracking-tight m-10">
            Wyskaluj  z nami swój biznes <FaGem       className="inline w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 ml-2 text-red-300 ml-2" />  już
            <span> </span>
          ...
          <p
            className={`leading-relaxed text-gray-300 mx-auto ${
              isMobile ? "text-base max-w-sm" : "text-lg md:text-xl max-w-4xl"
            }`}
            style={{
              fontWeight: 400,
              lineHeight: 1.6,
          ...
          >
            <span className="text-bold">Twoja strona musi być widoczna w erze nowych wyszukiwarek.{" "}</span>
             W 2025
            roku to najważniejszy czynnik rankingowy w Google - więc jak i
            również Twoich dochodów.
          </p>
          <p
            className={`leading-relaxed text-gray-300 mx-auto ${
              isMobile ? "text-base max-w-sm" : "text-lg md:text-xl max-w-4xl"
        ...
        <div className="max-w-9xl mx-auto mb-6 md:mb-6">
          ...
          >
            ...
            {isMobile ? (
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="bg-white rounded-3xl p-8 text-center"
                  ...
                  <div className="mb-8">
                    ...
                    <h3
                      className="text-3xl font-bold text-black mb-6 leading-tight tracking-tight"
                    ...
                    <div className="bg-black text-white px-6 py-3 rounded-full inline-block mb-2">
                      <span
                        className="text-sm font-medium tracking-wider"
                        style={{ fontFamily: "inherit" }}
                      >
                        CHCĘ BYĆ GOTOWA/Y NA ERĘ AI
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    <a
                      href="/contact"
                      className="group relative cursor-pointer transition-all duration-150 inline-block"
                    >
                      <p
                    ...
                    >
                      <div className="flex items-center gap-2 pb-1 justify-center">
                        ...
                        <ArrowRight className="w-5 h-5 text-blue-600 group-hover:translate-x-1 transition-transform duration-150" />
                      </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div
                    className="rounded-2xl p-6 text-center aspect-square flex flex-col items-center justify-center relative overflow-hidden"
                    style={{ background: 'radial-gradient(circle at left bottom, rgba(255, 116, 95, 0.1) 0%, #0f0f0f 38%)',
                  ...
                  >
                    ...
                    <h4
                      className="text-gray-400 font-medium text-lg relative z-10"
                      style={{ fontFamily: "inherit" }}
                    >
                  ...
                  <div
                    className="rounded-2xl p-6 text-center aspect-square flex flex-col items-center justify-center cursor-pointer transition-transform duration-150 relative overflow-hidden"
                    style={{
                  ...
                  >
                    ...
                    <h4
                      className="text-gray-400 font-medium text-base leading-tight relative z-10"
                      style={{ fontFamily: "inherit" }}
                    >
                    ...
                    <p
                      ...
                      style={{ fontFamily: "inherit" }}
                    >
                      Tak szybka, że ciężko ją doścignąć
                    </p>
                  </div>
                </div>

                {/* RESPONSYWNOŚĆ MOBILE - nowa sekcja */}
                <div
                ...
                >
                  <div className="space-y-6">
                    <h4
                      className="text-3xl lg:text-5xl md:font-thin text-white my-8 tracking-tight "
                      style={{ fontFamily: "inherit" }}
                    >
                ...
                {/* KONSULTACJE MOBILE - nowa sekcja */}
                <div
                  className="rounded-2xl p-6"
                ...
                >
                  <div className="space-y-6 text-center">
                    ...
                    >
                      Twoja strona,{" "}
                      <span
                        className="font-bold bg-gradient-to-r from-orange-300 to-pink-400 bg-clip-text text-transparent"
                        style={{ color: "#fd9f91" }}
                      >
                        Twoje zasady
                      </span>
                    ...
                    >
                      ...
                      rynek w Twoim obszarze. Dzięki temu tworzymy rozwiązania,
                      które rzeczywiście działają i przynoszą rezultaty.
                    </p>

                    <div className="flex flex-col gap-4 items-center">
                      <a
                        href="/contact"
                        className="group relative cursor-pointer transition-all duration-300 inline-block w-full"
                      >
                        <button className="cursor-pointer flex items-center gap-3 px-5 py-2 rounded-full bg-white text-black font-semibold text-base transition-all duration-300 hover:bg-gray-100 hover:shadow-xl active:scale-95 focus:outline-none focus:ring-4 focus:ring-white/30 w-full justify-center">
                          <span
                      ...
                      <a
                        ...
                        className="group relative cursor-pointer transition-all duration-300 inline-block w-full"
                      >
                        <button className="cursor-pointer flex items-center gap-3 px-5 py-2 rounded-full border-2 border-white bg-transparent text-white font-semibold text-base transition-all duration-300 hover:bg-white hover:text-black hover:shadow-xl active:scale-95 focus:outline-none focus:ring-4 focus:ring-white/30 w-full justify-center">
                          <span
                            className="select-none"
                            style={{ fontFamily: "inherit" }}
                          >
              ...
              /* Desktop Layout - elementy przyklejone do środkowego z responsywnością na dole */
              <div className="space-y-6">
                <div
                ...
                >
                  ...
                  <div className="col-span-3 row-span-3 col-start-3 relative">
                    ...
                    <div className="bg-white rounded-3xl p-12 flex flex-col justify-between shadow-xl h-full relative z-10 transition-transform duration-300 hover:scale-101"
                      style={{boxShadow: '0 0 20px rgba(255, 255, 255, 0.58), 0 0 40px rgba(255, 255, 255, 0.1)' }}
                    >
