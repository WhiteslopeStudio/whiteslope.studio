    ...
    return (
      <div className="fixed bottom-3 right-1 md:bottom-6 md:right-6 z-50 pointer-events-none">
        ...
        >
          ...
          <div 
            className="relative px-5 py-3 rounded-full backdrop-blur-xl shadow-2xl hover:shadow-[0_8px_32px_rgba(130,101,219,0.4)] transition-all duration-300 hover:scale-105 flex items-center gap-3 hover:cursor-pointer border border-[#8265db]/30 scale-[0.67] md:scale-100"
            style={{
