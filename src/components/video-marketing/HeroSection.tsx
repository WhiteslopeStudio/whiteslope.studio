  ...
  return (
    ...
    >
      ...
      <div className="h-full flex items-center relative">
        ...
        <motion.div
          className="hidden lg:block absolute right-[15%] top-1/2 -translate-y-1/2 w-72 xl:w-[360px]"
          style={{ zIndex: 5 }}
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        {/* Bottom - Social Media Icons and Button with connecting line */}
        <div className="absolute bottom-10 left-8 md:left-12 lg:left-36 right-8 md:right-12 lg:right-16 flex items-center justify-between" style={{ zIndex: 10 }}>
